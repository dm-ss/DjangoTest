# Generated by Django 3.1.4 on 2020-12-12 17:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.globalhost', verbose_name='HOST')),
                ('project', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api_test.project', verbose_name='项目')),
            ],
            options={
                'verbose_name': '用例定时任务',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=1024, null=True, verbose_name='内容')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='api_test.apiinfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '请求头',
                'verbose_name_plural': '请求头管理',
