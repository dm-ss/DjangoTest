...
from api_test.models import Project,Sys_Environment,Lyzd_Interface, GlobalHost, ApiGroupLevelFirst, ApiInfo, \
...
class EnvironmentForm(admin.ModelAdmin):
    search_fields = ('env_desc', 'address')
    list_display = ('id', 'env_desc', 'address', 'content')
    list_display_links = ('id', 'env_desc', 'address', 'content')
    list_filter = ('env_desc', 'address', 'content')
    list_per_page = 20
    ordering = ('id',)
    fieldsets = ([
        '环境配置', {

            'fields': ('env_desc', 'address', 'content')
        }],)


admin.site.register(Sys_Environment, EnvironmentForm)
...
class InterfaceForm(admin.ModelAdmin):
    search_fields = ('interface_name_zh', 'Project_id')
    list_display = ('interface_name_en', 'interface_name_zh', 'requestType', 'content','authentication'
                    ,'encryption','decrypt','delete_flag','requestParameterType','createTime','LastUpdateTime')
    list_display_links =('interface_name_en', 'interface_name_zh', 'requestType', 'content','authentication'
                    ,'encryption','decrypt','delete_flag','requestParameterType','createTime','LastUpdateTime')
    list_filter = ('interface_name_en', 'interface_name_zh', 'requestType', 'content','authentication'
                    ,'encryption','decrypt','delete_flag','requestParameterType','createTime','LastUpdateTime')
    list_per_page = 20
    ordering = ('id',)
    fieldsets = ([
        '接口配置', {
            ...
            'fields': ('interface_name_en', 'interface_name_zh', 'requestType', 'content','authentication'
                    ,'encryption','decrypt','delete_flag','requestParameterType','createTime','LastUpdateTime')
        }],)
admin.site.register(Lyzd_Interface, InterfaceForm)
