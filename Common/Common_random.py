...
def random_number_str(j):
    random_str =  ''.join(str(i) for i in random.sample(range(0,9),j))
    return random_str
...
def random_addr():
    ...
    addr = [(110000, u'北京市'),
            ...
            (659003, u'图木舒克市'),
            (659004, u'五家渠市')]
    random_address = random.choice(addr)

    return random_address,addr
...
def getBirthday(start="1900-01-01", end="2019-02-28"):
    """
    获取身份证7到14位，即出生年月日
